...
$evision_corporate_sections['evision-corporate-slider'] =
    array(
        ...
        'description'       => sprintf( __( 'Please select page for slider section. Page title will be slider title, page content will be slider content and page featured image will be slider image. You can manage page from %1$s here %2$s. Please use appropriate image size( about 1920*690 ) and select pages that have same size of images', 'evision-corporate' ), '<a href="'.esc_url( admin_url( 'edit.php?post_type=page' ) ).'" target="_self">','</a>' ),
